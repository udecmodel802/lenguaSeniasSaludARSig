...
namespace ArcGISRuntimeXamarin.Samples.CollectDataAR
{
    [ArcGISRuntime.Samples.Shared.Attributes.Sample(
        ...
        tags: new[] { "attachment", "Realidad Aumentada", "capture", "collection", "collector", "data", "field", "field worker", "full-scale", "mixed reality", "survey", "world-scale" })]
