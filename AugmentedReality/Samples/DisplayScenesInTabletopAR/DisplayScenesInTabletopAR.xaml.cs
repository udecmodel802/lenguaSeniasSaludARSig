...
namespace ArcGISRuntimeXamarin.Samples.DisplayScenesInTabletopAR
{
    [ArcGISRuntime.Samples.Shared.Attributes.Sample(
        name: "Mostrar escenas AR sobre una mesa",
        category: "Realidad Aumentada",
        description: "Use Realidad Aumentada (AR) to pin a scene to a table or desk for easy exploration.",
        ...
        tags: new[] { "Realidad Aumentada", "drop", "mixed reality", "model", "pin", "place", "table-top", "tabletop" })]
