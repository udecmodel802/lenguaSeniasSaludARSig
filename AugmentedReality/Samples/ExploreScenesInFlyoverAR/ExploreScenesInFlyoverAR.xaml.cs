...
namespace ArcGISRuntimeXamarin.Samples.ExploreScenesInFlyoverAR
{
    [ArcGISRuntime.Samples.Shared.Attributes.Sample(
        name: "Explora escenas AR en sobrevuelo",
        category: "Realidad Aumentada",
        description: "Use Realidad Aumentada (AR) to quickly explore a scene more naturally than you could with a touch or mouse interface.",
        ...
        tags: new[] { "Realidad Aumentada", "bird's eye", "birds-eye-view", "fly over", "flyover", "mixed reality", "translation factor" })]
