...
namespace ArcGISRuntimeXamarin.Samples.NavigateAR
{
    [ArcGISRuntime.Samples.Shared.Attributes.Sample(
        name: "Rutas en Realidad Aumentada",
        ...
        tags: new[] { "Realidad Aumentada", "directions", "full-scale", "guidance", "mixed reality", "navigate", "navigation", "real-scale", "route", "routing", "world-scale" })]
    ...
    public partial class RoutePlanner : ContentPage
    {
        ...
        private async Task Initialize()
        {
            ...
            MyMapView.Map = new Esri.ArcGISRuntime.Mapping.Map(BasemapStyle.ArcGISImageryStandard);
            ...
            HelpLabel.Text = "Toque para establecer un punto de inicio";
        }
        ...
        private void MapView_GeoViewTapped(object sender, GeoViewInputEventArgs e)
        {
            if (_startPoint == null)
            {
                ...
                // Update help text.
                HelpLabel.Text = "Toque la pantalla para establecer un punto final";
            }
            else if (_endPoint == null)
            {
                ...
                // Update help text.
                HelpLabel.Text = "Resolviendo ruta";
        ...
        private void EnableNavigation()
        {
            ...
            HelpLabel.Text = "Estas listo para comenzar a navegar!";
        }
