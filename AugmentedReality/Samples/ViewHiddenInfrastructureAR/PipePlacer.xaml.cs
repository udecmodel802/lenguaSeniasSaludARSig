...
namespace ArcGISRuntimeXamarin.Samples.ViewHiddenInfrastructureAR
{
    [ArcGISRuntime.Samples.Shared.Attributes.Sample(
        name: "Ver infraestructura oculta en AR",
        category: "Realidad Aumentada",
        description: "Visualize hidden infrastructure in its real-world location using Realidad Aumentada.",
        ...
        tags: new[] { "Realidad Aumentada", "full-scale", "infrastructure", "lines", "mixed reality", "pipes", "real-scale", "underground", "visualization", "visualize", "world-scale" })]
